  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gradient-to-b from-[#1a1a1a] via-[#2d1810] to-[#1a1a1a]">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab w-full h-full overflow-hidden relative outline-none active:cursor-grabbing block"
      />
      ...
      {activeItem && (
        ...
        `}
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none duration-100 translate-x-4 sm:translate-x-6'
        ...
        `}
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none duration-100 translate-y-4 sm:translate-y-4'
              : 'opacity-100 pointer-events-auto duration-500 translate-y-0 sm:translate-y-0'
          }
        `}
          >
            {activeItem.description}
          ...
          border-3 sm:border-4 md:border-5
          border-black
          rounded-full
          cursor-pointer
          transition-all
          ...
          ${
            isMoving
              ? 'bottom-[-100px] sm:bottom-[-120px] opacity-0 pointer-events-none duration-100 scale-0'
              : 'bottom-6 sm:bottom-8 md:bottom-12 lg:bottom-16 opacity-100 pointer-events-auto duration-500 scale-100'
          }
        `}
            aria-label="Ver más"
          >
            <span className="select-none text-base sm:text-lg md:text-2xl lg:text-3xl text-black">↗</span>
          </button>

          {/* Instrucción visual "Desliza para explorar" */}
          <div
            className={`
          absolute
          top-8 sm:top-10 md:top-16 lg:top-18
          left-1/2 -translate-x-1/2
          z-20
          pointer-events-none
          transition-all
        ...
        `}
          >
            <div className="flex flex-col items-center gap-2 sm:gap-3">
              <svg
                className="w-5 h-5 sm:w-6 sm:h-6 text-white/50 animate-bounce"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          {/* Overlay para mejor contraste en mobile */}
          <div className="absolute inset-0 pointer-events-none z-10">
            <div className="absolute inset-0 bg-gradient-to-r from-black/20 via-transparent to-black/20 md:from-black/10 md:via-transparent md:to-black/10 lg:opacity-0" />
          </div>
        </>
      )}
    </div>
